...
2. [Le 7 regole per scrivere un buon messaggio di commit](#le-7-regole)
	1. [Separare l'oggetto dal corpo del testo usando una riga vuota](#separazione-oggetto-dal-testo)
	2. [Non usare più di 50 caratteri per l'oggetto della commit](#non-usare-piu-di-50-caratteri-per-l-oggetto)
	3. [Capitalizzare l'oggetto della commit](#capitalizzare-l-oggetto-della-commit)
	4. [Non mettere il punto alla fine dell'oggetto della commit](#non-mettere-il-punto-alla-fine-dell-oggetto)
	5. [Scrivere l'oggetto della commit usando l'imperativo](#scriver-l-oggetto-della-commit-usando-l-imperativo)
	6. [Il corpo della commit deve andare a capo ogni 72 caratteri](#il-corpo-frlla-commit-deve-andare-a-capo-ogni-72-caratteri)
